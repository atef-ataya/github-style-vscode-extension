...
function getWebviewContent(webview, extensionUri) {
    ...
    const monacoLoaderUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'out', 'vs', 'loader.js'));
    const monacoUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'out', 'vs'));
